...
struct Config: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        try Decoding.rejectUnknownKeys(decoder, known: Set(CodingKeys.allCases.map(\.stringValue)), table: "")
...
struct WorktreeConfig: Decodable {
    ...
    init(from decoder: Decoder) throws {
        self.init()
        let c = try decoder.container(keyedBy: CodingKeys.self)
        try Decoding.rejectUnknownKeys(decoder, known: Set(CodingKeys.allCases.map(\.stringValue)), table: "worktree")
        ...
        if let v = try c.decodeIfPresent(String.self, forKey: .postCreateCommand) { postCreateCommand = v }
    }
}
...
struct TmuxConfig: Decodable {
    ...
    init(from decoder: Decoder) throws {
        self.init()
        let c = try decoder.container(keyedBy: CodingKeys.self)
        try Decoding.rejectUnknownKeys(decoder, known: Set(CodingKeys.allCases.map(\.stringValue)), table: "tmux")
        if let v = try c.decodeIfPresent(String.self, forKey: .tmuxinatorConfig) { tmuxinatorConfig = v }
    }
}
...
struct LinearConfig: Decodable {
    ...
    init(from decoder: Decoder) throws {
        self.init()
        let c = try decoder.container(keyedBy: CodingKeys.self)
        try Decoding.rejectUnknownKeys(decoder, known: Set(CodingKeys.allCases.map(\.stringValue)), table: "linear")
...
struct RemoteConfig: Decodable {
    ...
    init(from decoder: Decoder) throws {
        self.init()
        let c = try decoder.container(keyedBy: CodingKeys.self)
        try Decoding.rejectUnknownKeys(decoder, known: Set(CodingKeys.allCases.map(\.stringValue)), table: "remote")
...
struct ProjectConfig: Decodable {
    ...
    init(from decoder: Decoder) throws {
        self.init()
        let c = try decoder.container(keyedBy: CodingKeys.self)
        try Decoding.rejectUnknownKeys(decoder, known: Set(CodingKeys.allCases.map(\.stringValue)), table: "project")
...
struct PromptConfig: Decodable {
    ...
    init(from decoder: Decoder) throws {
        self.init()
        let c = try decoder.container(keyedBy: CodingKeys.self)
        try Decoding.rejectUnknownKeys(decoder, known: Set(CodingKeys.allCases.map(\.stringValue)), table: "prompt")
        if let v = try c.decodeIfPresent(String.self, forKey: .slashCommandsDir) { slashCommandsDir = v }
        if let v = try c.decodeIfPresent([InlineSection].self, forKey: .inlineSections) { inlineSections = v }
    }
}
...
struct InlineSection: Decodable {
    ...
    init(from decoder: Decoder) throws {
        let c = try decoder.container(keyedBy: CodingKeys.self)
        try Decoding.rejectUnknownKeys(decoder, known: Set(CodingKeys.allCases.map(\.stringValue)), table: "prompt.inline_sections")
...
struct GithubConfig: Decodable {
    ...
    init(from decoder: Decoder) throws {
        self.init()
        let c = try decoder.container(keyedBy: CodingKeys.self)
        try Decoding.rejectUnknownKeys(decoder, known: Set(CodingKeys.allCases.map(\.stringValue)), table: "github")
